    ...
    <div class="container py-4 py-md-5">
      ...
      <section class="auth-wizard-card mx-auto">
        ...
        <header class="text-center auth-wizard-header">
          ...
          <h1 class="auth-wizard-title mb-2">Verificar Correo</h1>
          <p class="auth-wizard-subtitle mb-3">
            Confirma tu identidad con tu <?= $role === 'egresado' ? 'correo personal' : 'correo institucional' ?>
          </p>
        ...
        <div class="auth-wizard-body">
          <div class="mb-4">
            <h2 class="auth-section-title mb-1">Verificación de correo</h2>
            <p class="auth-section-subtitle mb-0">
              Ingresa tu correo <?= $role === 'egresado' ? 'personal' : 'institucional' ?> <strong>@<?php echo htmlspecialchars($domainLabel); ?></strong>
            </p>
          </div>
            ...
            <form method="POST" class="needs-validation" autocomplete="off">
              ...
              <div class="mb-3">
                <label class="form-label" style="font-size:14px; font-weight:500;">
                  <?= $role === 'egresado' ? 'Correo Personal' : 'Correo Institucional' ?> <span class="text-danger">*</span>
                </label>
