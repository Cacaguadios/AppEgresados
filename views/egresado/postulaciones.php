                ...
                <?php else: ?>
                  ...
                  <div class="utp-card">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                      ...
                      <?php if ($matchPct > 0): ?>
                      <span style="font-size:13px; color:#757575;"><i class="bi bi-bullseye me-1"></i>Match: <?= $matchPct ?>%</span>
                      <?php endif; ?>
                      <a href="oferta-detalle.php?id=<?= (int)$p['oferta_id'] ?>" class="ms-auto btn btn-sm btn-outline-secondary" style="border-radius:8px;">
